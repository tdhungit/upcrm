    ...
    return Dep.extend({
        ...
        afterRender: function () {
            ...
            if (footerView) {
                ...
                if ((html.match(/upcrm/gi) || []).length < 2) {
                    var text = 'PHAgY2xhc3M9ImNyZWRpdCBzbWFsbCI+JmNvcHk7IDIwMTcgPGEgaHJlZj0iaHR0cHM6Ly91cGNybS52bi8iIHRpdGxlPSJQb3dlcmVkIGJ5IFVwQ1JNIiBhbHQ9IlZpc2l0IG9mZmljaWFsIFVwQ1JNIHdlYnNpdGUiPlVwQ1JNPC9hPiBmb3JrIG9mIEVzcG9DUk08L3A+';
